...
const VideoInfo = ({ title, description, publishedDate, viewCount, channelImage, channelTitle, subs }) => {
    let views = parseFloat(viewCount).toLocaleString('en')
    return (
        <div className='videoinfo'>
            ...
            <div className='videoinfo__stats'>
                <p className="views"> views • {views} {publishedDate}</p>
            ...
            <div className="videoinfo__channel">
                <div>
                    ...
                    <div className='videoinfo__channelinfo'>
                        <h1 className='videoinfo__channeltitle'>{channelTitle}</h1>
